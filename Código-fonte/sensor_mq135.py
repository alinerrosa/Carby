...
class MQ():
    ...
    RO_CLEAN_AIR_FACTOR          = 3.8     # RO_CLEAR_AIR_FACTOR=(Sensor resistance in clean air)/RO,
    ...
    def __init__(self, Ro=50, analogPin=0): #Ro = 10??
        self.Ro = Ro
        self.MQ_PIN = analogPin
        self.adc = MCP3008()
        
        self.CO2Curve = [2,0.004,-0.34]    # two points are taken from the curve. 
