...
#define MISO 21   // ADC 1 MISO. //DOUT
//#define MISO2 26  //     2
//#define MISO3 13  //     3
//#define MISO4 23  //     4
//#define MISO5 24  //     5
...
rawSPI_t rawSPI =
{
   .clk     =  23, // GPIO for SPI clock. 
   .mosi    = 19, // GPIO for SPI MOSI. //DIN
...
void getReading(
   int MISO, // The GPIO connected to the ADC data out.
   ...
   */
   ...
   while (sample<SAMPLES)
   {
      ...
      while (now_reading != reading)
      {
         ...
         */
         getReading(1, MISO, topOOL - ((reading%BUFFER)*BITS) - 1, 2, BITS, rx);
